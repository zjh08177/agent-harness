---
name: pua-debugging
description: "Use after 2+ failures, stuck loops, excuses, unverified environment blame, deflecting to user/manual steps, skipping verification, giving up, or user frustration. Applies to debugging, implementation, config, deployment, research, DevOps, API integration, and data tasks. Do not trigger on first-attempt failures or when a known fix is already in progress."
---
