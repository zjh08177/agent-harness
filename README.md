...
The meta-skills orchestrate sub-agents from these community projects. They work without them (degraded mode — lead agent handles everything inline), but full multi-agent orchestration requires them.

| Dependency | Role | Repo |
|-----------|------|------|
| **superpowers** | Planning templates, systematic debugging | [obra/superpowers](https://github.com/obra/superpowers) |
| **planning-with-files** | Persistent markdown task plans | [OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files) |
| **feature-dev** | code-explorer, code-architect, code-reviewer agents | [wshobson/agents](https://github.com/wshobson/agents) |
| **everything-claude-code** | Pioneered many of these harness patterns | [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) |
| **pr-review-toolkit** | Test coverage analysis | Built-in Claude Code plugin |
| **code-simplifier** | Post-implementation cleanup | Built-in Claude Code plugin |
